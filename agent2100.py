...
def main(sectors):
    ...
    try:
        ...
        for i in range(100):
            ...
            profitto1Y = trading1Years(symbols, stateAgent, trade_date, initial_date, endDate, budget, cur, conn, ticketPur, ticketSale, initial_budget, equity, margin, budgetInvestimenti, budgetMantenimento, profitTotalUSD, profitTotalPerc, symbols_data)
        ...
        insertDataDB.insertInMiddleProfit(idTest, "agent2", profittoMedio)
...
def trading1Years(symbols, stateAgent, trade_date, initial_date, endDate, budget, cur, conn, ticketPur, ticketSale, initial_budget, equity, margin, budgetInvestimenti, budgetMantenimento, profitTotalUSD, profitTotalPerc, symbols_data):
