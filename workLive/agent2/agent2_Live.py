...
#import session_management, info_order_send,symbols.symbolsAcceptedByTickmill as symbolsAcceptedByTickmill, 
#db.connectDB as connectDB, accountInfo, db.insertDataDB as insertDataDB, agentState
...
import session_management, info_order_send, accountInfo, agentState
from symbols import symbolsAcceptedByTickmill
from agent2 import agent2_Live as agent2
