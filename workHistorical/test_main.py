...
def main():
    ...
    #agent2.agent2_markCapDayInitial.main(datesToTrade1)
    agent2.agent2_markCapDayPurchase.main(datesToTrade1)
    agent2.agent2_selectRandom.main(datesToTrade1)
    
    agent3.agent3_markCapDayInitial.main(datesToTrade1)
    agent3.agent3_markCapDayPurchase.main(datesToTrade1)
    agent3.agent3_selectRandom.main(datesToTrade1)
    
    agent4.agent4_markCapDayInitial.main(datesToTrade1)
    agent4.agent4_markCapDayPurchase.main(datesToTrade1)
    agent4.agent4_selectRandom.main(datesToTrade1)
    
    agent5_variationNumberTitle.agent5_markCapDayInitial.main(datesToTrade1)
    agent5_variationNumberTitle.agent5_markCapDayPurchase.main(datesToTrade1)
    agent5_variationNumberTitle.agent5_selectRandom.main(datesToTrade1)
    
    agent7_larger_time_window.agent7_markCapDayInitial.main(datesToTrade1)
    agent7_larger_time_window.agent7_markCapDayPurchase.main(datesToTrade1)
    agent7_larger_time_window.agent7_selectRandom.main(datesToTrade1)
